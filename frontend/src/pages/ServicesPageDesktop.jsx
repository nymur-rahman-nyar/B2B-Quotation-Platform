// src/pages/ServicesPageDesktop.jsx
import React, { useEffect, useState } from "react";
import { FaTimes, FaCheckCircle } from "react-icons/fa";
import { useNavigate } from "react-router-dom";

export default function ServicesPageDesktop({ apiBase }) {
  ...
  // Add service to a simple list of { id, name }
  ...
  return (
    <div className="hidden md:block min-h-screen bg-gray-100 px-40 py-6">
      {/* Static intro */}
      ...
      <div className="mb-6 flex items-center justify-between">
        <input
          ...
          className="w-full md:w-1/2 border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-400"
        />
